class PhysiciansController < ApplicationController
  ...
  private
    ...
    def physician_params
      ...
      #params.require(:physician).permit(:name, office_attributes: [:id, :name, :done, :_destroy])
      #params.require(:physician).permit(:name, :specialty_attributes: [:id, :name, :done, :_destroy])
    end
end
